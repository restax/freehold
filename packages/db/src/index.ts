...
export const CriticalMessageTrigger = PrismaPkg.CriticalMessageTrigger;
export type CriticalMessageTrigger = PrismaPkg.CriticalMessageTrigger;
...
export const TaskKind = PrismaPkg.TaskKind;
export type TaskKind = PrismaPkg.TaskKind;
export const AssigneeRole = PrismaPkg.AssigneeRole;
export type AssigneeRole = PrismaPkg.AssigneeRole;
export const AssigneeSlot = PrismaPkg.AssigneeSlot;
export type AssigneeSlot = PrismaPkg.AssigneeSlot;
export const TemplateGroupKind = PrismaPkg.TemplateGroupKind;
export type TemplateGroupKind = PrismaPkg.TemplateGroupKind;
...
export const ComplianceSide = PrismaPkg.ComplianceSide;
export type ComplianceSide = PrismaPkg.ComplianceSide;
export const CompliancePaymentStatus = PrismaPkg.CompliancePaymentStatus;
export type CompliancePaymentStatus = PrismaPkg.CompliancePaymentStatus;
...
export const StateClosingModel = PrismaPkg.StateClosingModel;
export type StateClosingModel = PrismaPkg.StateClosingModel;
